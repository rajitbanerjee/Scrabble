...
public class DarkMode implements BotAPI {
    ...
    public static class Move {
        ...
        //blanks may not be necessary, we can remove it later if it isn't
         ...
         * @param newLetters List of letters in word coming from the frame.
         * @param blanks     List of letters in word which are blank tiles
         */
        Move(boolean horizontal, String word, Coordinate start, ArrayList<Integer> newLetters, ArrayList<Integer> blanks) {
        ...
        ArrayList<Integer> getNewLetters() {
            return newLetters;
        }

        //Returns the list of letters in word which are blank tiles
        ArrayList<Integer> getBlanks() {
            return blanks;
        }
